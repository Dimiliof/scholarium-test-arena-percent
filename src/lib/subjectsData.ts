...
export const sampleQuestions: Record<string, QuizQuestion[]> = {
  ...
  'history': [
    ...
    {
      id: 3,
      question: 'Ποια μάχη θεωρείται καθοριστική για την έκβαση ��ου Β΄ Πα����οσμίου Πολ��μου στην Ευρώπη;',
  ...
  'ecdl-word': [
    {
      id: 1,
      question: 'Ποιος από τα παρακάτω πλήκτρα συντόμευσης χρησιμοποιείται για την αποθήκευση ενός εγγράφου στο Word;',
